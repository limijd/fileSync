...
def main():
    ...
    parser.add_argument('-rd', '--report_dup', action='store_true', default=True, help='report duplicated files in source directory')
    parser.add_argument('-rcf', '--report_copied_files', action='store_true', default=True, help='report copied files from source directory')
